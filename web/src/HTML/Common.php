...
abstract class Common
{
    ...
    /**
     * In general, this should not be used unless you want to explicitly
     * declare a non-standard line ending.
     *
     ...
     * @return  void
     */
    function setLineEnd($style = null)
    {
        switch ($style) {
            case 'win':
                $this->_lineEnd = "\15\12";
